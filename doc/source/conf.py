...
# -*- coding: utf-8 -*-
#
# EVM Decompiler documentation build configuration file, created by
...
project = 'EVM Decompiler'
year = datetime.datetime.now().year
copyright = ' %d, The University of Sydney' % year
...
html_theme_options = {
    'description': 'Ethereum VM bytecode decompiler.',
...
html_title = 'EVM Decompiler v0.0.1'
...
htmlhelp_basename = 'EVMDecompilerdoc'
...
latex_documents = [
    (master_doc, 'EVMDecompiler.tex', 'EVM Decompiler Documentation',
     'The University of Sydney', 'manual'),
]
